...
class Dot():
    ...
    def get_files(self, dotignore=".dotignore"):
        """
        Generate the full path of files in your dotfile directory.
        Thes full paths will include both full paths to your $HOME directory
        and full paths to your dot directory.
        git_files() is used before link() and unlink()
         """
